...
<body>
	...
	<div class="register">
		<nav>
			<a href="/add/team">Create a Team</a> |
		...
		<div class="col">
			...
			<form:form action="/add/team" method="POST" modelAttribute="team" class="reg">
				...
				<div class="form-group">
					<form:label path="skill" class="form-label">Skill Level(one - five):</form:label>
                    <form:errors path="skill" class="text-danger" />
                    <form:input type="text" path="skill" class="form-control" />
				</div>
				
				<div class="form-group">
					<form:label path="players" class="form-label">Players:</form:label>
