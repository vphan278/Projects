...
//	  }
	  ...
	  public String register(@Valid @ModelAttribute("newUser") User newUser,
	                         ...
	                         Model model,
	                         HttpSession session,
	                         RedirectAttributes redirectAttributes) { // Include RedirectAttributes
	      ...
	      // Store a flash message for successful registration
	      redirectAttributes.addFlashAttribute("successMessage", "Account created successfully. Login to play ball!");
