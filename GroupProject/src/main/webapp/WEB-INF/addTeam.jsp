		...
		<div class="col">
			...
			<form:form action="/add/team" method="POST" modelAttribute="team" class="reg">
				...
				<div class="form-group">
                    ...
                    <form:select path="teamname" class="form-control">
                    	<form:option value="" label="Choose your team" />
                    	<form:option value="Raiders" label="Raiders" />
                    	<form:option value="Cowboys" label="Cowboys" />
                    	<form:option value="49ers" label="49ers" />
                    </form:select>
				</div>
